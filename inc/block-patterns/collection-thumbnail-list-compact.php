 ...
 */
return array(
	'title'      => __( 'Query (List, compact)', 'maisie' ),
	'categories' => array( 'maisie-query' ),
	'content'    => '<!-- wp:query {"className":"wp-block-query--theme-pattern","query":{"perPage":3,"pages":0,"offset":"0","postType":"post","categoryIds":[],"tagIds":[],"order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"list","columns":3}} -->
					<div class="wp-block-query wp-block-query--theme-pattern">
						<!-- wp:post-template -->
							<!-- wp:post-featured-image {"isLink":false,"width":"300px","height":"150px","className":"wp-block-post__media"} /-->
						
							<!-- wp:group {"className":"wp-block-post__text"} -->
							<div class="wp-block-group wp-block-post__text">
								<!-- wp:post-title {"isLink":false,"className":"box-title"} /-->

								<!-- wp:group {"className":"has-no-row-gap","layout":{"type":"flex","justifyContent":"left"}} -->
								<div class="wp-block-group has-no-row-gap"><!-- wp:post-author {"showAvatar":false,"showBio":false,"byline":"By","fontSize":"small"} /-->
